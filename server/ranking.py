...
ranking_area_top10_response1_documents = Ranking.model(
    "Ranking_area_top10_response1_documents",
    {
        "rank": fields.Integer(),
        "second_region": fields.String(),
        "total": fields.Integer(),
...
ranking_area_myrank_response1_documents = Ranking.model(
...
ranking_area_myrank_response1_data = Ranking.model(
    "Ranking_area_myrank_response1_data",
    {
        "first_region": fields.String(),
        "documents": fields.List(
            fields.Nested(ranking_area_myrank_response1_documents),
        ),
    },
)
